...
function About() {
  return (
    <>
      <div>
        <div className="grid Archivo justify-center text-center">
          <h3 className="text-4xl Archivo  font-semibold text-gray-200">Whatever is UIkit</h3>
          <p className="col-8 mx-auto  mt-5 leading-8 text-gray-300">Whatever UIKit provides various types of Figma UI design kits that can be used by designers or developers. Whatever also provides attractive designs and affordable prices for each design kit.</p>
        </div>
        <div>
              ...
              <div className="overflow-hidden border hover:scale-105 duration-200 rounded-lg">
                <div className="px-4 py-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h4 className="text-4xl font-bold text-gray-200">6+</h4>
              ...
              <div className="overflow-hidden hover:scale-105 duration-200  border rounded-lg">
                <div className="px-4 py-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h4 className="text-4xl font-bold text-gray-200">37+</h4>
              ...
              <div className="overflow-hidden border hover:scale-105 duration-200 rounded-lg">
                <div className="px-4 py-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h4 className="text-4xl font-bold text-gray-200">3,274</h4>
              ...
              <div className="overflow-hidden border hover:scale-105 duration-200  rounded-lg">
                <div className="px-4 py-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h4 className="text-4xl font-bold text-gray-200">98%</h4>
