    ...
    <>
      <div>
        <div className="grid justify-center text-center">
          ...
          <p className="col-8 mx-auto Archivo mt-5 leading-8 text-gray-300">Whatever UIKit provides various types of Figma UI design kits that can be used by designers or developers. Whatever also provides attractive designs and affordable prices for each design kit.</p>
        </div>
        <div>
          <section>
