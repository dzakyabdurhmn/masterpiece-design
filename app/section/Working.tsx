function Working() {
  return (
    <>
      <section>
        <div className="px-4 mx-auto max-w-7xl mb-40 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-semibold text-gray-200 leading-tight sm:text-4xl lg:text-4xl">How does it work?</h2>
            <p className="max-w-lg mx-auto mt-4 leading-7 text-gray-300">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis.</p>
          </div>
          ...
          <div className="relative mt-12 lg:mt-20">
            ...
            <div className="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12">
              <div>
                ...
                <p className="mt-4 text-base text-gray-300 leading-7">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
              </div>
